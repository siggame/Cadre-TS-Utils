...
export declare type FinishedEvent = IEvent<"finished", {
...
export declare type RunEvent = IEvent<"run", {
 ...
 */
export declare type PlayEvent = IEvent<"play", {
    /**
 ...
 * string game alias.
 */
export declare type AliasEvent = IEvent<"alias", string>;
/** One of the possible events that a client can send to its server. */
export declare type ClientEvent = AliasEvent | PlayEvent | RunEvent | FinishedEvent;
