 ...
 */
export declare type OverEvent = IEvent<"over", {
 ...
 */
export declare type StartEvent = IEvent<"start", {
    /**
 ...
 * For the "order" event.
 */
export declare type OrderEvent = IEvent<"order", {
 ...
 */
export declare type InvalidEvent = IEvent<"invalid", {
 ...
 */
export declare type LobbiedEvent = IEvent<"lobbied", {
 ...
 */
export declare type RanEvent = IEvent<"ran", unknown>;
/**
 ...
 */
export declare type DeltaEvent = IEvent<"delta", Delta["game"]>;
/**
...
export declare type ServerEvent = NamedEvent | LobbiedEvent | StartEvent | OrderEvent | RanEvent | DeltaEvent | MetaDeltaEvent | InvalidEvent | FatalEvent | OverEvent;
