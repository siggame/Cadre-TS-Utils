 ...
 */
export type InvalidEvent = Event<
    "invalid",
    {
 ...
 */
export type LobbiedEvent = Event<
    "lobbied",
    {
 ...
 */
export type RanEvent = Event<"ran", unknown>;
 ...
 */
export type DeltaEvent = Event<"delta", Delta["game"]>;
