 ...
 * around.
 */
export declare function getWrapAround<T, A extends ReadonlyArray<T>>(array: A, element: T, offset?: number): A extends ReadonlyArray<NonEmptyArray<T>> ? T : T | undefined;
